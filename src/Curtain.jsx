  ...
  return (
    <div style={{ overflow: 'hidden', position: 'relative', height: '100vh', width: '100vw' }}>
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 }}>
        ...
        <h2>A la recherche d'une alternance dans le domaine de la transformation digiitale</h2>
        <p>Cliquez en dessous pour en savoir plus sur moi</p>
        <div className="panel">
      ...
      <motion.div
        ...
        style={{
          ...
          bottom: 0,
          width: '100px',
          backgroundColor: '#444', // Couleur du petit rideau
