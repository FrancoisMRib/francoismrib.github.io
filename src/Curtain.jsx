    ...
    <div style={{ overflow: 'hidden', position: 'relative', height: '100vh', width: '100vw' }}>
      ...
      <motion.div
        ...
        style={{
          ...
          bottom: 0,
          width: '250px',
          backgroundImage: `url('./Petit_rideau_portfolio-removebg-preview.png')`,
      ...
      <motion.div
        ...
        style={{
          ...
          bottom: 0,
          width: '100vw',
          backgroundImage: `url('./Grand_rideau_texte_portfolio2.jpg')`, // Remplacer par le chemin de votre image
          backgroundSize: 'cover', // L'image couvre toute la surface
          backgroundPosition: 'center',
          cursor: 'grab',
          zIndex: 10,
